...
The IP API endpoint allows you to access information regarding IPs, allocated to your Mailgun account, used for outbound sending.
...
.. container:: ptable
 ...
 ================= ========================================================
 dedicated         Return only dedicated IPs if set to `true`. (all is returned by default)
 ================= ========================================================
...
.. note:: Only dedicted IPs can be assigned to a domain.
...
Get a list of IPs from domain pool.
