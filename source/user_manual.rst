...
You can set the preferred method for replies to a list:
* ``list`` Replies to the list go to the list address. This is the default setting for any new list created, except for read-only lists, where replies can only go to the sender.
